...
mod tests {
    ...
    fn test_vlog_generation() -> miette::Result<()> {
        ...
        let expect = expect![[r#"
            ...
            module top_interp_i_cic(input wire [1:0] clock_reset, input wire [14:0] i, output wire [14:0] o);
               ...
               top_interp_i_cic_integrators c1(.clock_reset(clock_reset), .i(d[43:22]), .o(q[43:22]));
               top_interp_i_cic_phase c2(.clock_reset(clock_reset), .i(d[47:44]), .o(q[47:44]));
               top_interp_i_cic_out c3(.clock_reset(clock_reset), .i(d[58:48]), .o(q[58:48]));
               top_interp_i_cic_starved c4(.clock_reset(clock_reset), .i(d[59:59]), .o(q[59:59]));
               assign d = od[74:15];
            ...
            module top_interp_q_cic(input wire [1:0] clock_reset, input wire [14:0] i, output wire [14:0] o);
               ...
               top_interp_q_cic_integrators c1(.clock_reset(clock_reset), .i(d[43:22]), .o(q[43:22]));
               top_interp_q_cic_phase c2(.clock_reset(clock_reset), .i(d[47:44]), .o(q[47:44]));
               top_interp_q_cic_out c3(.clock_reset(clock_reset), .i(d[58:48]), .o(q[58:48]));
               top_interp_q_cic_starved c4(.clock_reset(clock_reset), .i(d[59:59]), .o(q[59:59]));
               assign d = od[74:15];
               assign od = kernel_cic_interpolate_kernel(clock_reset, i, q);
               function [74:0] kernel_cic_interpolate_kernel(input reg [1:0] arg_0, input reg [14:0] arg_1, input reg [59:0] arg_2);
                     reg [21:0] r0;
    ...
    fn test_trace() -> miette::Result<()> {
        ...
        let expect = expect!["93ff7d5ed475da33ac9e11d11e30bf1c4c746f573cc42804966e67d60b72a1aa"];
