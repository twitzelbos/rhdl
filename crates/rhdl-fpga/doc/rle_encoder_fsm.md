...
<p>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 310 230" font-family="sans-serif" font-size="13">
...
<title>FSM diagram for RleEncoder</title>
...
<line x1="85" y1="200" x2="225" y2="160" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
...
<text x="85" y="185" text-anchor="middle">emit count</text>
<rect x="170" y="160" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="225" y="185" text-anchor="middle">emit data</text>
</svg>
