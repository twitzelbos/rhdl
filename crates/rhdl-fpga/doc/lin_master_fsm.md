...
<p>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 170 1270" font-family="sans-serif" font-size="13">
...
<title>FSM diagram for LinMaster</title>
...
<line x1="85" y1="850" x2="85" y2="940" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<path d="M 73 940 C 60 905, 110 905, 97 940" fill="none" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<line x1="85" y1="980" x2="85" y2="1070" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<line x1="85" y1="1110" x2="85" y2="1200" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<line x1="85" y1="1240" x2="85" y2="30" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<path d="M 73 1200 C 60 1165, 110 1165, 97 1200" fill="none" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
...
<text x="85" y="185" text-anchor="middle">break</text>
<rect x="30" y="290" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="315" text-anchor="middle">send sync</text>
<rect x="30" y="420" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="445" text-anchor="middle">wait sync</text>
<rect x="30" y="550" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="575" text-anchor="middle">send PID</text>
<rect x="30" y="680" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="705" text-anchor="middle">wait PID</text>
<rect x="30" y="810" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="835" text-anchor="middle">send data</text>
<rect x="30" y="940" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="965" text-anchor="middle">wait data</text>
<rect x="30" y="1070" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="1095" text-anchor="middle">send chk</text>
<rect x="30" y="1200" width="110" height="40" rx="6" ry="6" fill="#ffffff" stroke="#444" stroke-width="1"/>
<text x="85" y="1225" text-anchor="middle">wait chk</text>
</svg>
