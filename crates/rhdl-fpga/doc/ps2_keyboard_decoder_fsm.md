...
<p>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 360" font-family="sans-serif" font-size="13">
...
<title>FSM diagram for Ps2KeyboardDecoder</title>
...
<line x1="85" y1="200" x2="225" y2="30" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<path d="M 73 160 C 60 125, 110 125, 97 160" fill="none" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<line x1="85" y1="200" x2="225" y2="290" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<line x1="225" y1="200" x2="225" y2="30" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<path d="M 213 160 C 200 125, 250 125, 237 160" fill="none" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<line x1="225" y1="330" x2="225" y2="30" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<path d="M 213 290 C 200 255, 250 255, 237 290" fill="none" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
<line x1="365" y1="200" x2="225" y2="30" stroke="#666" stroke-width="1.5" marker-end="url(#arrow)"/>
