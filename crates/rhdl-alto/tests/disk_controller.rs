...
fn write_and_read_kstat() {
    ...
    let trace = run_inputs(
        ...
        vec![
            CtrlIn {
                reg_addr: b3(REG_KSTAT as u8),
                write_data: b16(0x4321),
                write_en: true,
                clr_stat: false,
            },
            CtrlIn {
...
fn kadr_field_decode() {
    ...
    let trace = run_inputs(
        ...
        vec![
            CtrlIn {
                reg_addr: b3(REG_KADR as u8),
                write_data: b16(kadr_value),
                write_en: true,
                clr_stat: false,
            },
            CtrlIn {
...
fn each_register_independent() {
    ...
    let trace = run_inputs(
        ...
        vec![
            ...
            CtrlIn {
                reg_addr: b3(REG_KSTAT as u8),
                write_data: b16(0x1111),
                write_en: true,
                clr_stat: false,
            },
            CtrlIn {
                reg_addr: b3(REG_KDATA as u8),
                write_data: b16(0x2222),
                write_en: true,
                clr_stat: false,
            },
            CtrlIn {
                reg_addr: b3(REG_KCOM as u8),
                write_data: b16(0x3333),
                write_en: true,
                clr_stat: false,
            },
            CtrlIn {
                reg_addr: b3(REG_KADR as u8),
                write_data: b16(0x4444),
                write_en: true,
                clr_stat: false,
            },
            CtrlIn {
                reg_addr: b3(REG_KCWA as u8),
                write_data: b16(0x5555),
                write_en: true,
                clr_stat: false,
            },
            CtrlIn {
                reg_addr: b3(REG_KCWD as u8),
                write_data: b16(0x6666),
                write_en: true,
                clr_stat: false,
            },
